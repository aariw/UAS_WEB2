                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="tempat_lahir" class="form-control" placeholder="Masukkan Tempat Lahir "  value="{{ is_null
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="date" name="tgl_lahir" class="form-control" placeholder="Masukkan Tanggal Lahir "  value="{{ is_null
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="alamat" class="form-control" placeholder="Masukkan Alamat "  value="{{ is_null
                                    ($mahasiswa) ? '' : $mahasiswa->alamat }}">
                                </div>
                                <div class="col">
                                    <label for="">Telepon</label>
                                    <input type="number" name="telepon" class="form-control" placeholder="Masukkan Telepon "  value="{{ is_null
